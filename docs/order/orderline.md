<!-- catalog-anchor: order_model_order_line -->
# OrderLine
...
<!-- catalog-anchor: order_model_order_line_field_order_id -->
- order_id: str - 소속 Order의 ID

<!-- catalog-anchor: order_model_order_line_field_sku -->
- sku: str - 상품 식별자 (대문자 영숫자와 하이픈, 최대 20자)

<!-- catalog-anchor: order_model_order_line_field_quantity -->
- quantity: int - 주문 수량 (> 0)

## 형식 제약

<!-- catalog-anchor: order_constraint_sku_is_uppercase_alnum_hyphen_max_20 -->
### SKU 형식은 제한된다
...
<!-- catalog-anchor: order_property_order_line_sku_format_validation -->
### SKU 형식 검증
